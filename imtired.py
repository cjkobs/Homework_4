...
def generalized_reduced_gradient():
    ...
    fx = x1 ** 3 + x2 ** 2 + x3 ** 2  # Function to be minimized
    ...
    xcurr = np.array([0, 5 / sqrt(6), 5 / sqrt(6)])  # Starting solution
    ...
    for outer_iter in range(max_outer_iter):
        ...
        while alpha > 0.001:
            ...
            for iter in range(max_iter):
                print
                'Iteration: {0}, optimal solution obtained at x = {1}'.format(iter + 1, v)
